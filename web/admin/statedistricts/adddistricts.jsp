        ...
        <div class="smart-wrap">
            <div class="smart-forms smart-container wrap-full">
                ...
                <div class="form-header header-blue">
                    ...
                    <div style="position: absolute;top:5px;right:5px;width: 100px;"><a href="<%=request.getContextPath()%>//admin/statedistricts/init.io" class="button btn-primary block pushed expand"> <spring:message code="common.button.search" text="Search" /> </a></div>

                </div><!-- end .form-header section -->

                <form:form method="post" action="${action}"  commandName="district">
                        ...
                        <div class="frm-row">
                            ...
                            <div class="section colm colm6"> 
                                <div class="section">
                                    ...
                                    <label class="field prepend-icon"><form:select path="state_id" id="state_id" class="gui-input">
                            ...
                            <div class="section colm colm6">
                                <div class="section">
                                    <label for="names" class="field-label"><spring:message code="statedistrict.adddistrict" text="Add District" /></label>
                                    <label class="field prepend-icon">
                                    <form:input path="districtName" id="districtName" class="gui-input" placeholder="Enter District Name"/>
