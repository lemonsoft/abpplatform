    ...
    <body >
        ...
        <div class="smart-wrap">
            <div class="smart-forms smart-container wrap-full">
                ...
                <div class="form-header header-blue">
                    <h4><i class="fa fa-pencil-square"></i><spring:message code="importmultilanguage.title" text="Import Multilingual Questions" /></h4>
                    <div style="position: absolute;top:5px;right:5px;width: 100px;"><a href="<%=request.getContextPath()%>/admin/questions/init.io" class="button btn-primary block pushed expand"><spring:message code="importmultilanguage.question" text="Questions" /> </a></div>
                            ...
                            <div class="section colm colm12"> 
                                <div class="section" style='overflow:auto;width:1200px;'>
                                    <table id="example-basic4" class="table table-striped table-bordered table-hover dt-responsive"  border="1" cellpadding="2" cellspacing="2" id="format">
                                        ...
                                        <th><spring:message code="importmultilanguage.option4" text="Option4" /></th><th><spring:message code="importmultilanguage.option5" text="Option5" /></th>
                                        </thead>
                                    </table>
                                </div><!-- end section -->
                            </div><!-- end section -->
                        ...
                        <c:if test = "${importdata !=null}">
                            <div class="frm-row" style='overflow:auto;width:1200px;height:650px;'>
                                <display:table name="importdata" class="table table-bordered" requestURI="importQuestionExcel.io"  pagesize="50">
                                    ...
                                    <display:column property="option5" titleKey="importmultilanguage.option5" />
        ...
        <script>
            ...
            function startimport() {
                ...
                window.location.href = "<%=request.getContextPath()%>/admin/questions/insertMultiQuestions.io";
