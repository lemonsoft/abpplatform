...
<div class="page-wrapper-row">
    <div class="page-wrapper-bottom">
        ...
        <div class="page-footer">
            <div class="container"> 2017 &copy; The Assessors Guild
...
<script src="<%=request.getContextPath()%>/assets/layouts/layout3/scripts/layout.min.js" type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/assets/layouts/layout3/scripts/demo.min.js" type="text/javascript"></script>
